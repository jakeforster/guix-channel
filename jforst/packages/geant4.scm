  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0h1mpc795lzq0z562jiq8w7rv0l1kwjjb98ynydqmxb0djnsmsli"))))
  ...
  (let ((version "4.6"))
    (origin
      ...
      (uri (string-append "https://cern.ch/geant4-data/datasets/G4NDL."
                          version ".tar.gz"))
      (sha256 (base32 "022l2jjhi57frfdv9nk6s6q23gmr9zkix06fmni8gf0gmvr7qa4x")))))
  ...
  (let ((version "5.5"))
    (origin
      ...
      (uri (string-append
            ...
            version ".tar.gz"))
      (sha256 (base32 "1mvnbs7yvkii41blks6bkqr8qhxgnj3xxvv1i3vdg2y14shxv5ar")))))
  ...
  (let ((version "5.4"))
    (origin
      ...
      (uri (string-append
            ...
            ".tar.gz"))
      (sha256 (base32 "0qaark6mqzxr3lqawv6ai8z5211qihlp5x2hn86vzx8kgpd7j1r4")))))
  ...
  (let ((version "2.1"))
    (origin
      ...
      (uri (string-append "https://cern.ch/geant4-data/datasets/G4PARTICLEXS."
            version ".tar.gz"))
      (sha256 (base32 "0h8ba8jk197npbd9lzq2qlfiklbjgqwk45m1cc6piy5vf8ri0k89")))))
  ...
  (let ((version "2.1.1"))
    (origin
      ...
      (uri (string-append
            ...
            ".tar.gz"))
      (sha256 (base32 "0l3gs0nlp10cjlwiln3f72zfch0av2g1r8m2ny9afgvwgbwiyj4h")))))
  ...
  (let ((version "2.2"))
    (origin
      ...
      (uri (string-append "https://cern.ch/geant4-data/datasets/G4ENSDFSTATE."
            version ".tar.gz"))
      (sha256 (base32 "19p0sq0rmyg48j9hddqy24dn99md7ddiyq09lyj381q7cbpjfznx")))))
    ...
    (source
     (origin
       ...
       (uri (string-append "http://cern.ch/geant4-data/releases/geant4-v"
                           version ".tar.gz"))
       (sha256
        (base32 "0sg45nd47ajqhzncw5fahrrx8a9s54x1l31l6xa73xsx5bmj54fj"))))
    (build-system cmake-build-system)
    ...
    (source
     (origin
       ...
       (uri (string-append "http://cern.ch/geant4-data/releases/geant4-v"
                           version ".tar.gz"))
       (sha256
        (base32 "1ma7qswqf320v03ry3j9sc20rjvn5ailp3g9k32bk7vlw29jsy3v"))))))
